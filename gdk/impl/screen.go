...
func (v *Screen) GetRGBAVisual() (gdk.Visual, error) {
...
func (v *Screen) GetSystemVisual() (gdk.Visual, error) {
...
func (v *Screen) GetActiveWindow() (gdk.Window, error) {
