...
func init() {
	iface.FONT_SLANT_NORMAL = C.CAIRO_FONT_SLANT_NORMAL
	iface.FONT_SLANT_ITALIC = C.CAIRO_FONT_SLANT_ITALIC
	iface.FONT_SLANT_OBLIQUE = C.CAIRO_FONT_SLANT_OBLIQUE

	iface.FONT_WEIGHT_NORMAL = C.CAIRO_FONT_WEIGHT_NORMAL
	iface.FONT_WEIGHT_BOLD = C.CAIRO_FONT_WEIGHT_BOLD
}

func (v *Context) SelectFontFace(family string, slant iface.FontSlant, weight iface.FontWeight) {
