...
func (v *Context) Status() cairo.Status {
...
func (v *Context) GetTarget() cairo.Surface {
...
func (v *Context) PushGroupWithContent(content cairo.Content) {
...
func (v *Context) GetGroupTarget() cairo.Surface {
