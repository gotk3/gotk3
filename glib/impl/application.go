...
func ApplicationNew(appID string, flags glib.ApplicationFlags) *Application {
...
func (v *Application) GetFlags() glib.ApplicationFlags {
	return glib.ApplicationFlags(C.g_application_get_flags(v.native()))
}

// SetFlags is a wrapper around g_application_set_flags().
func (v *Application) SetFlags(flags glib.ApplicationFlags) {
...
func (v *Application) SendNotification(id string, notification glib.Notification) {
	cstr1 := (*C.gchar)(C.CString(id))
	defer C.free(unsafe.Pointer(cstr1))
