...
func WrapList(obj uintptr) glib.List {
	return wrapList((*C.struct__GList)(unsafe.Pointer(obj)))
}

func wrapList(obj *C.struct__GList) glib.List {
	if obj == nil {
		return nil
	}
...
func (v *List) wrapNewHead(obj *C.struct__GList) glib.List {
	if obj == nil {
		return nil
	}
	return &List{
...
func (v *List) Nth(n uint) glib.List {
