...
import cairo_impl "github.com/gotk3/gotk3/cairof"
import gdk_impl "github.com/gotk3/gotk3/gdkf"
import glib_impl "github.com/gotk3/gotk3/glibf"
...
func (*RealGtk) SizeGroupNew(m gtk.SizeGroupMode) (gtk.SizeGroup, error) {
	return SizeGroupNew(m)
}
