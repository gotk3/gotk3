...
func (v *menuShell) SelectItem(child gtk.MenuItem) {
	C.gtk_menu_shell_select_item(v.native(), castMenuItemToWidget(child))
}
...
func (v *menuShell) ActivateItem(child gtk.MenuItem, forceDeactivate bool) {
	C.gtk_menu_shell_activate_item(v.native(), castMenuItemToWidget(child), gbool(forceDeactivate))
}
