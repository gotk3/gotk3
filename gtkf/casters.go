...
func castToWidget(w gtk.Widget) *C.GtkWidget {
	if w == nil {
		return nil
	}
	return w.(IWidget).toWidget()
}

func castMenuToWidget(w gtk.Widget) *C.GtkWidget {
	if w == nil {
		return nil
	}
	return w.(IMenu).toWidget()
}

func castMenuItemToWidget(w gtk.Widget) *C.GtkWidget {
	if w == nil {
		return nil
	}
	return w.(IMenuItem).toWidget()
}
